...
public class AnimationAndMovementControllerWithJumping : MonoBehaviour
{
    ...
    void setupJumpVariables()
    {
        ...
        float secondJumpGravity = (-2 * (maxJumpHeight + 0.2f)) / Mathf.Pow((timeToApex * 1.25f), 2);
        float secondJumpInitialVelocity = (2 * (maxJumpHeight + 0.2f)) / (timeToApex * 1.25f);
        float thirdJumpGravity = (-2 * (maxJumpHeight + 0.2f)) / Mathf.Pow((timeToApex * 1.5f), 2);
        float thirdJumpInitialVelocity = (2 * (maxJumpHeight + 0.2f)) / (timeToApex * 1.5f);
    ...
    void Update()
    {
        ...
        characterController.Move(appliedMovement * Time.deltaTime * 80);
